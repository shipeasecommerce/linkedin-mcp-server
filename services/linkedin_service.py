...
class LinkedInService(BaseService):
    ...
    async def _start_auth_flow(self, params: Dict[str, Any]) -> ServiceResponse:
        ...
        scope = params.get("scope", "openid profile email w_member_social w_organization_social r_organization_social r_compliance r_member_social r_dma_admin_pages_content")
